...
const Footer = () => {
  return (
     <motion.div 
      ...
      transition={{duration:0.6}} className='px-6 md:px-24 lg:px-32 xl:px mt-60 text-sm text-gray-500'>

            <motion.div 
             initial={{opacity:0, y:20}}
             whileInView={{opacity:1, y:0}}
             transition={{duration:0.6, delay:0.2}} className='flex flex-wrap justify-between items-start gap-12 md:gap-8 pb-6 border-borderColor border-b'>
                <div>
                    <motion.img 
                     initial={{opacity:0}}
                    ...
                    transition={{duration:0.5, delay:0.5}} className='flex items-center gap-3 mt-6'>
                        {/* Instagram */}
                        <a href="#"><img src={assets.instagram_logo} alt="facebook logo" className='w-5 h-5' /></a>
                        {/* Facebook */}
                         <a href="#"><img src={assets.facebook_logo} alt="facebook logo" className='w-5 h-5' /></a>
                        {/* Twitter */}
                         <a href="#"><img src={assets.twitter_logo} alt="facebook logo" className='w-5 h-5' /></a>
                        {/* Gmail */}
                        <a href="#"><img src={assets.gmail_logo} alt="facebook logo" className='w-5 h-5'/></a>
                ...
                <motion.div 
                 initial={{opacity:0, y:20}}
                whileInView={{opacity:1, y:0}}
                transition={{duration:0.6, delay:0.4}}  className='flex flex-wrap justify-between w-1/2 gap-8'>
                    <div>
